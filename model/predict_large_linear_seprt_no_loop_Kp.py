...
def predict():
    ...
    with torch.no_grad():
        for batch_idx, batch_data in enumerate(dataloader):
            ...
            latent_img_pre, _, _ = recon_model(img_pre, img_cur)
            K_T_pre = dyn_model(img_pre)
            ...
            latent_img_cur, _, _ = recon_model(img_cur, img_post)
            K_T_cur = dyn_model(img_cur)
...
folder_name = 'test_large_Kp_g_KL_cleandata'
