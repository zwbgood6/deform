...
def train(e2c_model):
    ...
    for batch_idx, batch_data in enumerate(trainloader):
        ...
        loss = loss_bound + GAMMA_kl * loss_kl
        loss.backward()
    ...
    return train_loss/n, bound_loss/n, kl_loss/n
...
for epoch in range(init_epoch, epochs+1):
    train_loss, train_bound_loss, train_kl_loss = train(e2c_model)
    ...
    if epoch % args.log_interval == 0:
        ...
        loss_logger = {'train_loss_all': train_loss_all, 'train_bound_loss_all': train_bound_loss_all,
                       'train_kl_loss_all': train_kl_loss_all, 'test_loss_all': test_loss_all,
                       'test_bound_loss_all': test_bound_loss_all, 'test_kl_loss_all': test_kl_loss_all,
                       'test_pred_loss_all': test_pred_loss_all}
        torch.save({
                    'epoch': epoch,
