...
def train_new(epoch, recon_model, dyn_model):
    recon_model.train()
    dyn_model.train()
    train_loss = 0
    img_loss = 0
...
parser.add_argument('--folder-name', default='train_all_together', 
...
for epoch in range(init_epoch, epochs+1):                                                
    train_loss, train_img_loss, train_act_loss, train_latent_loss, train_pred_loss = train_new(epoch, recon_model, dyn_model) # change here
